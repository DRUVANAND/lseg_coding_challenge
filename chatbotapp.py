...
# @app.route('/')
# def home_menu():
#     print("Home menu accessed")  # Optional: for debugging
#     return render_template('home.html')

# @app.route('/stocks/<exchange>', methods=['GET'])
# def stock_menu(exchange):
#     print(f"Stock menu accessed for exchange: {exchange}")  # Optional: for debugging
#     if exchange in stock_data:
#         stocks = stock_data[exchange]['topStocks']
...
#     print(f"Stock price accessed for exchange: {exchange}, stock code: {stock_code}")  # Optional: for debugging
#     if exchange in stock_data:
#         stocks = stock_data[exchange]['topStocks']
